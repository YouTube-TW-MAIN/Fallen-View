...
S = '\033[1;33m'
logo=(f'''{B}{E}====================================================={E}
{E} This Script Is Free Made By @FallenDirectory Don't Share Without Credit...{B}
|         {G}[+] ᴅᴇᴠᴇʟᴏᴘᴇʀ : {B}Fallen                            |
|         {G}[+] ɢɪᴛʜᴜʙ ᴜsᴇʀɴᴀᴍᴇ   : {B}@YouTube-TW-MAIN          |
|         {G}[+] ᴛᴇʟᴇɢʀᴀᴍ ᴜsᴇʀɴᴀᴍᴇ : {B}@CONTACTMEBYUSINGTHIS     |
|         {G}[+] ᴛᴇʟᴇɢʀᴀᴍ ᴄʜᴀɴɴᴇʟ  :  {B}@FallenDirectory          |
{E}=====================================================''')
def tui():
    while True:
        print(logo)
